...
public class ArvBinBusca <Chave extends Comparable<Chave>, Valor>  {
    ...
    //complexidade O(n), pois o metodo percorre simultaneamente uma vez todos os nós das duas arvores, comparando-os.
    public boolean eSimilar(ArvBinBusca<Chave, Valor> arvore){

        return eSimilarRec(this.raiz, arvore.raiz);

    }

    private boolean eSimilarRec(No no1, No no2){
        ...
        return eSimilarRec(no1.esq, no2.esq) && eSimilarRec(no1.dir, no2.dir);
    }
}
