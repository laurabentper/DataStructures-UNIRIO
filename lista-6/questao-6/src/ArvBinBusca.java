...
public class ArvBinBusca<Chave extends Comparable<Chave>, Valor>  {
    ...
    //complexidade O(n*h), onde h é a altura da arvore, pois o metodo acessa recursivamente todos os nós da arvore
    // chamando o metodo altura e checando se suas subárvores estao balanceadas.
    ...
    private boolean eBalanceada(No x) {
        ...
        return eBalanceada(x.esq) && eBalanceada(x.dir);
    }
